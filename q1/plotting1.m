...
scatter(x, y, 10, 'color', 'b', 'DisplayName', 'MSOA data');  
hold on;
% Plot the fitted line
plot(x, mdl.Fitted, '-', 'color', 'y', 'LineWidth', 1, 'DisplayName', 'Linear Fit');
% Customize axis labels and title
xlabel('Log of Distance', 'FontSize', 12);
ylabel('Log of Scaled Demand', 'FontSize', 12);
title('Fitting linear model', 'FontSize', 14);
